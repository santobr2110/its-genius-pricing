...
const TIERS: {
  ...
  { id: "tierMonitor",     label: "Monitor",     icon: Activity,   desc: "Monitoramento de ativos (Servidores, Rede, Firewall)",                  available: true,  alias: "Bronze",  aliasIcon: Medal,  aliasClass: "bg-gradient-to-r from-amber-600 to-orange-700 text-white",  selectedClass: "border-amber-400 bg-amber-50/70 dark:bg-amber-950/30 dark:border-amber-800" },
    { id: "tierOperation",   label: "Operation",   icon: Zap,        desc: "Gestão de TI com N1/N2 e N3 em horas - rotinas preventivas básicas. Aqui podemos aplicar field remoto ou presencial",             available: true,  alias: "Silver",  aliasIcon: Award,  aliasClass: "bg-gradient-to-r from-slate-400 to-zinc-500 text-white",     selectedClass: "border-slate-400 bg-slate-100/80 dark:bg-slate-800/40 dark:border-slate-600" },
   { id: "tierPerformance", label: "Performance", icon: Gauge,      desc: "Rotinas preventivas e de complexidade · exige Monitor + Operation", available: true, alias: "Gold",    aliasIcon: Trophy, aliasClass: "bg-gradient-to-r from-yellow-500 to-amber-600 text-yellow-950",  selectedClass: "border-yellow-400 bg-yellow-50/70 dark:bg-yellow-950/30 dark:border-yellow-800" },
  { id: "tierEnterprise",  label: "Enterprise",  icon: Building2,  desc: "Em breve",                                                                available: false, alias: "Diamond", aliasIcon: Gem,    aliasClass: "bg-gradient-to-r from-cyan-400 to-sky-600 text-white" },
];
