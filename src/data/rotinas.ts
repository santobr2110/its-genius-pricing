...
export const ROTINAS_DEFAULT: Rotina[] = [
  ...
  r("lnx-1", "Sistema Operacional Linux", "Health Check", "Operation", "Por Servidor", true, "Semanal"),
  r("win-1", "Sistema Operacional Windows", "Análise de segurança/compliance do Active Directory (AD)", "Operation", "Por Servidor", false, "Mensal"),
  r("win-2", "Sistema Operacional Windows", "Health Check", "Operation", "Por Servidor", true, "Semanal"),
