...
import { DollarSign, TrendingUp, Percent, Wallet, Calculator, Receipt, Table as TableIcon, Plus, Trash2, RefreshCw } from "lucide-react";
...
const COMPONENTES: { key: CompKey; label: string; descricao: string; max: number }[] = [
  ...
  { key: "lucroPerc",     label: "Rentabilidade",        descricao: "Rentabilidade pretendida da operação. Define automaticamente a comissão pela tabela abaixo.", max: 60 },
];

export default function ConfiguracoesFinanceiras() {
  const { state, update, results, comissaoTiers, setComissaoTiers } = useITSMContext();
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-5">
              ...
              {/* Comissão derivada da rentabilidade */}
                ...
                <div className="flex justify-between items-center">
                  <div className="min-w-0">
                    ...
                    <p className="text-[11px] text-muted-foreground leading-snug">
                      Definida pela faixa de rentabilidade na tabela abaixo. Não editável diretamente.
                    </p>
                  </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            {comissaoTiers.map((t, idx) => {
              const isLast = idx === comissaoTiers.length - 1;
              return (
